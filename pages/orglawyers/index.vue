<template>
    <div>
        <div class="org-laywers">
            <div class="content-title">
                <h3>Aдвокатлар реестри тузилмаси</h3>
            </div>
            ...
            route: [
                {
                    url: "lawyers",
                    value: {
                        uz: "Advokatlar reestri tuzilmasi",
                        kr: "Адвокатлар реестри тузилмаси",
                        ru: "Структура реестра адвокатов"
                    }
                }
            ]
        };
